...
museumyes = [
    {
        'name': 'Набережная ДВФУ',
        'location': 'Набережная ДВФУ',
        'time': '9:00-10:00',
        'description': 'Набережная лучшего вуза страны',
        'img': 'https://primamedia.ru/f/big/390/389490.jpg?4009e56b772c68051cd3f17285783df5',
        'tags': ['прогулка']
    },
    {
        'name': 'Мидия',
        'location': 'ул. Адмирала Фокина, 1а',
        'time': '10:00-11:00',
        'description': 'Уютное кафе в центре города с самыми оригинальными напитками и вкусными морепродуктами',
        'img': 'http://primamedia.today/files/post/medium_a7a84bb.jpg',
        'tags': ['кафе', 'морепродукты']
    },
    {
        'name': 'Музей Арсеньева',
        'location': 'Светланская 20',
    ...
    {
        'name': 'Оззи бар',
        'location': 'ул. Алеутская, 14а',
        'time': '18:00-21:00',
        'description': 'Маленький бар в центре Владивостока с вкусной едой и недорогим алкогелем',
        'img': 'https://sun9-42.userapi.com/c624528/v624528671/e3af/YJNnS3dtciM.jpg',
